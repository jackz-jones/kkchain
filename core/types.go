...
type Processor interface {
	...
	//process concurrent .add by lmh 20181101
	ProcessConcurrent(routineNum int, block *types.Block, statedb *state.StateDB, cfg vm.Config) (types.Receipts, []*types.Log, uint64, error)
}
