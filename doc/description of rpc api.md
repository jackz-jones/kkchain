...
（11）立即执行合约调用，而不创建交易        5

（12）估算给定交易完成所需的gas值        6
...
目前，各rpc接口基本沿用以太坊的，所以各接口的参数和返回结果可以参考以太坊官方说明：[https://github.com/ethereum/wiki/wiki/JSON-RPC](https://github.com/ethereum/wiki/wiki/JSON-RPC)。
